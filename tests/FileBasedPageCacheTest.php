...
class FileBasedPageCacheTest extends \PHPUnit\Framework\TestCase {
	...
	public function test_url_exception_match() {
		...
		$this->assertTrue( atozsites_url_exception_match( $exception ) );
		$_SERVER = array();
		...
		$this->assertFalse( atozsites_url_exception_match( $exception ) );
		$_SERVER = array();
	...
	public function test_url_exception_match_regex() {
		...
		$this->assertTrue( atozsites_url_exception_match( $exception, true ) );
		$_SERVER = array();
		...
		$this->assertFalse( atozsites_url_exception_match( $exception, true ) );
		$_SERVER = array();
