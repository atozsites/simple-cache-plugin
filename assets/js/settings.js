...
const $enableInMemoryCache = jQuery(document.getElementById('atozsites_enable_in_memory_object_caching'));
...
const $advancedModeToggle = jQuery(document.getElementById('atozsites_advanced_mode'));
...
const pageCachingSimple = document.getElementById('atozsites_enable_page_caching_simple');
const pageCachingAdvanced = document.getElementById('atozsites_enable_page_caching_advanced');
const pageCacheLengthSimple = document.getElementById('atozsites_page_cache_length_simple');
const pageCacheLengthAdvanced = document.getElementById('atozsites_page_cache_length_advanced');
const pageCacheLengthUnitSimple = document.getElementById('atozsites_page_cache_length_unit_simple');
const pageCacheLengthUnitAdvanced = document.getElementById('atozsites_page_cache_length_unit_advanced');
const gzipCompressionSimple = document.getElementById('atozsites_enable_gzip_compression_simple');
const gzipCompressionAdvanced = document.getElementById('atozsites_enable_gzip_compression_advanced');
