...
if ( empty( $batcache ) && ! empty( $GLOBALS['atozsites_config'] ) && isset( $GLOBALS['atozsites_config']['page_cache_length'] ) ) {
	$max_age = $GLOBALS['atozsites_config']['page_cache_length'] * 60;
...
if ( ! empty( $GLOBALS['atozsites_config']['cache_exception_urls'] ) ) {
