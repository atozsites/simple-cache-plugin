...
class atozsites_Config {
	...
	public function write( $config, $force_network = false ) {
		...
		$config_dir = atozsites_get_config_dir();
	...
	public function get() {
		if ( atozsites_IS_NETWORK ) {
			$config = get_site_option( 'atozsites_simple_cache', $this->get_defaults() );
		} else {
			$config = get_option( 'atozsites_simple_cache', $this->get_defaults() );
		}
	...
	public function clean_up() {
		...
		if ( atozsites_IS_NETWORK ) {
			delete_site_option( 'atozsites_simple_cache' );
		} else {
			delete_option( 'atozsites_simple_cache' );
		}
